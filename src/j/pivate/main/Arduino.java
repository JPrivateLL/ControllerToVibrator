...
public final class Arduino extends JArduino {
	...
	private Arduino(final String port)
			throws NullPointerException, NoSuchPortException {
		super(port);
	...
	public static Short getFSRStrength() {
		AnalogPin[] pinList = { AnalogPin.A_0, AnalogPin.A_1, AnalogPin.A_2,
				AnalogPin.A_3, AnalogPin.A_4, AnalogPin.A_5 };
