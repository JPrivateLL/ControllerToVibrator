...
public class VibrationDown extends Vibration {
	...
	protected VibrationDown(String name, boolean[] vibType, int pos,int stage, int number, float strength,float minStrength, float interval, float time, float onTime,float startDelay, float amount, boolean plugRequired) {
		super(name, vibType, pos, stage, number, "Down", strength, minStrength, interval,	time, onTime, startDelay, amount, plugRequired);
